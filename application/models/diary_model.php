...
class Diary_model extends CI_Model  {
	...
	public function calculateResult($score){ 
	 	$tip = '';
	   	if($score==0||$score<0){ 
			$tip="小戒评估结果:你确定你是来养生吗？请好好填写自评并对自己负责吧";
		}
			...
			$tip="小戒评估结果：今天这是一份不错的养生成绩单，希望你每天都能保持这个状态，步步前进，稳扎稳打，恶习戒除成功指日可待";
		}	
		else if($score>=80&&$score<100){ 
			$tip="小戒评估结果：你真的很棒，如果这个分数能以保持2周以上，你就离养生成功不远了，小戒以你为荣，你的养生日记经过审查后会推荐到微信的文章中去";
		}
		else if($score>=100){ 
			$tip="小戒评估结果：你简直太棒了，你已经超越了所有人，希望这是你今天真实的养生成绩，你的养生日记经过审查后会推荐到微信的文章中去，愿荣誉永远与你同在";
		}			
		return $tip;	
	}
